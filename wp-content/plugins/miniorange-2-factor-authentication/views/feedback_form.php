            ...
            <div class="mo2f_feedback_text">
                ...
                <div class="mo2f_modal-footer">
                    ...
                    <input type="submit" name="miniorange_feedback_submit"
                           class="button button-primary button-large" style="float:right" value="Submit"/>
                    <input type="button" name="miniorange_feedback_skip"
                           class="button button-primary button-large" style="float:left" value="Skip & Deactivate"
