        ...
        <div>
            <form name="f" method="post" action="" >
                ...
                <input type="checkbox" onChange="mo_toggle_inline()" style="padding-top: 50px;float: right;" id="mo2f_inline_registration"
                       ...
                       value="<?php MoWpnsUtility::get_mo2f_db_option('mo2f_inline_registration', 'get_option') ?>" <?php  checked( MoWpnsUtility::get_mo2f_db_option('mo2f_inline_registration', 'get_option') == 1 );?>/>
                <span class="mo_wpns_slider"></span>
                </label>
