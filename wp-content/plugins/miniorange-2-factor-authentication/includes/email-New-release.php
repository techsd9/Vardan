...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div>
    <div class="mo_2fa_email_feature_details" style="background-color: white;text-align: center;min-height: 160px;color: black;font-family: inherit;border-radius: 15px;border: 1px solid #20b2aa;font-size: 12px;">
						<h2 class="mo_2fa_email_feature_title">PaidMembership Pro</h2>
					<ul class="mo_2fa_feature_ul">
          <li>2FA support on PaidMembership Pro form</li>
          <li>All the strings/messages translatable on checkout</li>
  ...
  <div>
    <div class="mo_2fa_email_template_details" style="background-color: white;border-top: 5px solid #20b2aa;min-height: 250px;text-align: center;overflow: hidden;font-size: 15px;">
								...
								<div style="min-height: 150px;">
									...
									<p class="mo_2fa_feature_text">miniOrange provides easy to use 2 Factor authentication for secure login to your WordPress site <br>
  ...
  <div>
    <div class="mo_2fa_email_template_details" style="background-color: white;border-top: 5px solid #20b2aa;min-height: 250px;text-align: center;overflow: hidden;font-size: 15px;">
							...
							<div style="min-height: 110px;">
								...
								<p class="mo_2fa_feature_text">Secure your website with miniOrange Limit Login Attempts plugin. <br><br>
								<a class="mo_2fa_ef_read_more" href="https://wordpress.org/plugins/miniorange-limit-login-attempts/">...Know More</a></p>
							</div>
						</div>
  </div>
