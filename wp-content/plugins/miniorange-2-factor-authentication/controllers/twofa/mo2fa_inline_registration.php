...
function prompt_user_to_select_2factor_mthod_inline($current_user_id, $login_status, $login_message,$redirect_to,$session_id,$qrCode){
    ...
    if($current_selected_method == "miniOrange QR Code Authentication" || $current_selected_method == "miniOrange Push Notification" || $current_selected_method == "miniOrange Soft Token"||$current_selected_method == 'MOBILE AUTHENTICATION' || $current_selected_method == 'SOFT TOKEN' || $current_selected_method == 'PUSH NOTIFICATIONS'){
    ...
    else if($current_selected_method == 'GOOGLE AUTHENTICATOR' || $current_selected_method == 'Google Authenticator'){
