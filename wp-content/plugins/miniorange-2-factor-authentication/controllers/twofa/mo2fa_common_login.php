...
function redirect_user_to($user, $redirect_to)
{
    ...
    if(is_multisite()){
        ...
        if(is_super_admin($user->ID)){
            ...
            $redirectUrl  = isset($redirect_to ) && ! empty($redirect_to ) ? $redirect_to  : admin_url();
            
        }elseif($current_role=='administrator'){
           
            $redirectUrl = empty($redirect_to) ? admin_url() : $redirect_to;
            
        }else{
            
            $redirectUrl = empty($redirect_to) ? home_url() : $redirect_to;
        }
    }else{
